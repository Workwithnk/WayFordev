...
function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        At wayfordev, accessible from https://wayfordev.web.app/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        wayfordev and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in wayfordev. This policy is not applicable to any
      ...
      <p>
        wayfordev follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of wayfordev.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on wayfordev, which are sent
      ...
      <p>
        Note that wayfordev has no access to or control over these cookies that
      ...
      <p>
        wayfordev's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        wayfordev does not knowingly collect any Personal Identifiable
