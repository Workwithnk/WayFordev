...
function TermsAndCon() {
  return (
    <div className="TermsAndCon  commanPrivacy">
      ...
      <p>Welcome to wayfordev!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Nk development's Website, located at https://wayfordev.web.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use wayfordev if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing wayfordev, you agreed to use
        cookies in agreement with the Nk development's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Nk development and/or its licensors own the
        intellectual property rights for all material on wayfordev. All
        intellectual property rights are reserved. You may access this from
        wayfordev for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from wayfordev</li>
        <li>Sell, rent or sub-license material from wayfordev</li>
        <li>Reproduce, duplicate or copy material from wayfordev</li>
        <li>Redistribute content from wayfordev</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Nk
        development does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Nk development,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Nk development
      ...
      <p>
        Nk development reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Nk development a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Nk development; and (d) the
      ...
      <p>
        ...
        e-mail to Nk development. Please include your name, your organization
      ...
      <p>
        No use of Nk development's logo or other artwork will be allowed for
