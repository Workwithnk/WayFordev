...
function Disclaimer() {
  return (
    <div>
      ...
      <p>
        All the information on this website - https://wayfordev.web.app/ - is
        published in good faith and for general information purpose only.
        wayfordev does not make any warranties about the completeness,
        reliability and accuracy of this information. Any action you take upon
        the information you find on this website (wayfordev), is strictly at
        your own risk. wayfordev will not be liable for any losses and/or
